...
public class Restaurante {
	...
	/*metodos */
	public static  void cargarInformacionRestaurante (File archivoIngredientes, File archivoMenu, File archivoCombos, File archibebidas) throws IOException {
	...
	public static  void cargarIngredientes (File archivoIngredientes) throws IOException {
	...
	public static  void cargarMenu (File archivoMenu) throws IOException {
